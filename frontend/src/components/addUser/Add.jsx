...
const Add = () => {
   ...
   const navigate = useNavigate;
    ...
    const submitForm = async(e) =>{
        ...
        .then((response)=>{
           toast.success(response.data.msg, {postion : "top-right"})
            navigate("/")
        })
            ...
            <div className="inputGroup">
                ...
                <div className="inputGroup">
                    <label htmlFor="password">Password</label>
                     <input type='text' id='password' onChange={inputHandler}  name='password' autoComplete='off' placeholder='password'/>
                </div>
                <div className="inputGroup">
